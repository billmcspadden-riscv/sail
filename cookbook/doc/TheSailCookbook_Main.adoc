...
should be called.  Note also that the opening of the scattered definition(s) are 
done in this file;  it might be a good idea to put the opening of the scattered
